...
use App\Http\Controllers\Admin\UploadedNewsController;
...
Route::get('/debug-contest', function () {
    try {
        ...
        $contests = Contest::with('images')->get();
...
Route::get('/contest', function () {
    try {
        ...
        $contest = Contest::where('is_active', 1)
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin.auth'])->group(function () {
        ...
        Route::resource('uploaded-news', UploadedNewsController::class)->except(['show']);
        Route::post('uploaded-news/{uploaded_news}/toggle-status', [UploadedNewsController::class, 'toggleStatus'])->name('uploaded-news.toggle-status');

        // Alternative route name for backward compatibility
        Route::get('uploaded_news', [UploadedNewsController::class, 'index'])->name('uploaded_news.index');
...
Route::get('/debug/uploaded-news', function () {
    $allNews = UploadedNews::all();
    $activeNews = UploadedNews::active()->get();
