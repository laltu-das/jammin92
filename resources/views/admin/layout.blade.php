    ...
    <div class="row">
        ...
        <div class="col-md-2 p-0 sidebar">
            ...
            <ul class="nav flex-column">
                <li><a href="{{ route('admin.index') }}" class="{{ request()->is('admin') ? 'active' : '' }}"><i
                                class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                <li><a href="{{ route('admin.contests.index') }}"
                       class="{{ request()->is('admin/contests*') ? 'active' : '' }}"><i class="fas fa-trophy"></i>
                        Contests</a></li>
                <li><a href="{{ route('admin.uploaded-news.index') }}"
                       class="{{ request()->is('admin/uploaded-news*') ? 'active' : '' }}"><i
                                class="fas fa-newspaper"></i> Uploaded News</a></li>
                <li><a href="{{ route('admin.ads.index') }}"
                       class="{{ request()->is('admin/ads*') ? 'active' : '' }}"><i class="fas fa-ad"></i> Ads
                        Management</a></li>
                <li><a href="{{ route('admin.footer.index') }}"
                       class="{{ request()->is('admin/footer*') ? 'active' : '' }}"><i class="fas fa-cog"></i> Footer
                        Management</a></li>
                <li><a href="{{ route('admin.apis') }}" class="{{ request()->is('admin/apis*') ? 'active' : '' }}"><i
                                class="fas fa-plug"></i> API Settings</a></li>
            </ul>
