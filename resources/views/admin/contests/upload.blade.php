                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.contests.upload.store', $contest) }}" method="POST"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mb-2">
                                            <div class="btn-group w-100" role="group">
                                                <input type="radio" class="btn-check" name="storage_source"
                                                       id="local_storage" value="local" checked autocomplete="off">
                                                <label class="btn btn-outline-secondary" for="local_storage">
                                                    <i class="fas fa-folder-open"></i> Local Files
                                                </label>

                                                <input type="radio" class="btn-check" name="storage_source"
                                                       id="google_drive" value="google_drive" autocomplete="off">
                                                <label class="btn btn-outline-secondary" for="google_drive">
                                                    <i class="fab fa-google-drive"></i> Google Drive
                                                </label>

                                                <input type="radio" class="btn-check" name="storage_source"
                                                       id="onedrive" value="onedrive" autocomplete="off">
                                        ...
                                        <div id="cloud_storage_input" class="storage-input d-none">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="cloud_file_path"
                                                       name="cloud_file_path" placeholder="No files selected" readonly>
                                            ...
                                            <small class="form-text text-muted">Select images from your cloud
                                                storage.</small>
                                        </div>

                                        <div class="form-text">You can select multiple images. Maximum size: 2MB per
                                            image. Supported formats: JPG, PNG, GIF.
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">This description will be applied to all uploaded
                                            images.
                                        </div>
                                    </div>
                                    ...
                                    const mockFiles = [
                                        {
                                            ...
                                            id: 'onedrive1',
                                            url: 'https://onedrive.live.com/123'
                                        },
                                        {
                                            name: 'stage_setup.png',
                                            id: 'onedrive2',
                                            url: 'https://onedrive.live.com/456'
                                        },
