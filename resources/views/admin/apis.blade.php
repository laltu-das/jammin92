        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        <a href="{{ route('admin.contests.index') }}" class="btn btn-outline-primary me-2">Contest
                            Management</a>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="showApiValues"
                                   onchange="toggleApiValues()">
                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach($apis as $api)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <form action="{{ route('admin.apis.toggle', $api->id) }}"
                                                    ...
                                                    <form action="{{ route('admin.apis.destroy', $api->id) }}"
                                                          method="POST"
                                                          class="d-inline"
                                                          onsubmit="return confirm('Are you sure you want to delete this API?')">
                                                        @csrf
                                                        @method('DELETE')
