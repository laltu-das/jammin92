    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content contest-modal-content">
            <div class="modal-header border-0">
                ...
                <button type="button" class="btn-close btn-close-white contest-modal-close" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                ...
                @else
                    ...
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted">There are no active contests at the moment. Please check back later for upcoming contests and exciting opportunities to win VIP tickets!</p>
                    </div>
                @endif
            </div>
