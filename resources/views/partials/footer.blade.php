                ...
                <div class="col-md-4">
                    <div class="footer-column">
                        ...
                        <ul class="list-unstyled footer-links">
                            <li><a href="{{ $footer->home_link_url }}"><i class="fas fa-chevron-right me-2"></i> {{ $footer->home_link_text }}</a></li>
                            <li><a href="{{ $footer->news_link_url }}"><i class="fas fa-chevron-right me-2"></i> {{ $footer->news_link_text }}</a></li>
                ...
                <div class="col-md-4">
                    <div class="footer-column">
                        ...
                        <ul class="list-unstyled footer-links">
                            ...
                            <li><a href="tel:{{ preg_replace('/[^0-9+]/', '', $footer->phone) }}"><i class="fas fa-phone-alt me-2"></i> {{ $footer->phone }}</a></li>
                            <li><a href="mailto:{{ $footer->email }}"><i class="fas fa-envelope me-2"></i> {{ $footer->email }}</a></li>
                            <li><a href="#"><i class="fas fa-broadcast-tower me-2"></i> Frequency: {{ $footer->frequency }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
