        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <div id="adsCarousel" class="carousel slide carousel-fade shadow-lg" data-bs-ride="carousel"
                         data-bs-interval="5000" style="border: 2px solid #0d6efd;">
                        <!-- Indicators -->
    ...
    <section class="section section-bg" id="concerts">
        <div class="container">
            <div class="section-header">
                ...
                <p class="lead">Discover amazing Pop concerts happening in your area, including shows by trending
                    artists like Taylor Swift, Ed Sheeran, and more</p>
            </div>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="input-group">
                        ...
                        <input type="text"
                               ...
                               autocomplete="off">
                        <button class="btn btn-outline-secondary" type="button" id="use-my-location-btn"
            ...
            <div class="mt-5 pt-4 border-top border-light">
                ...
                <div class="col-12 text-center" id="trending-no-artists" style="display: none;">
                    <div class="alert alert-info">
                        ...
                        <p class="mb-0">No trending Pop artists currently have scheduled concerts. Check back later for
                            updates!</p>
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h3>Studio Tour</h3>
                            <p>Get a behind-the-scenes look at our broadcasting facilities and see how radio magic
                                happens.</p>
                            <a href="#" class="btn">Learn More</a>
                        </div>
                    </div>
